...
typedef enum actor_e
{
    ...
    ACTOR_29A_ZUBBA_DOOR_AUTUMN = 0x29A,
    ACTOR_29B_ZUBBA,
    ...
    ACTOR_2A5_BOOM_BOX_MINIGAME_CTRL = 0x2A5,
    ACTOR_2A6_NABNUT_SPRING = 0x2A6,
...
enum bs_e {
    ...
    BS_B_UNKOWN = 0xB,
    BS_C_SKID = 0xC,
    BS_D_TIMEOUT_TRANSFORMATION = 0xD,
    BS_E_OW = 0xE,
    BS_F_BBUSTER = 0xF,
    BS_10_BFLAP = 0x10,
    BS_11_BPECK = 0x11,
    ...
    BS_1F_WALK_CREEP = 0x1F,
    BS_20_LANDING = 0x20,
    BS_21_BSHOCK_CHARGE = 0x21,
    BS_22_BSHOCK_JUMP = 0x22,
    BS_23_FLY_ENTER = 0x23,
    BS_24_FLY = 0x24,
    BS_25_LONGLEG_ENTER = 0x25,
    BS_26_LONGLEG_IDLE = 0x26,
    BS_27_LONGLEG_WALK = 0x27,
    BS_28_LONGLEG_JUMP = 0x28,
    BS_29_LONGLEG_EXIT = 0x29,
    BS_2A_BOMB = 0x2A,
    ...
    BS_52_SURF = 0x52, //tumblar??? a.k.a bssurf
    BS_53_TIMEOUT_BANJO = 0x53,    
    BS_54_SWIM_DIE = 0x54,
    BS_55_LONGLEG_SLIDE = 0x55,
    BS_56_RECOIL = 0x56,
    BS_57_BOMB_END = 0x57,
    BS_58_BEAKBOMB_CRASH = 0x58,
    BS_59_BFLY_UNK59 = 0x59,
    BS_5A_LOADZONE = 0x5A,
    BS_5B_CARRY_THROW = 0x5B,


    BS_5E_CROC_IDLE = 0x5E,
    BS_5F_CROC_WALK = 0x5F,
    BS_60_CROC_JUMP = 0x60,
    ...
    BS_68_WALRUS_WALK = 0x68,
    BS_69_WALRUS_JUMP = 0x69,
    BS_6A_WALRUS_FALL = 0x6A,
    BS_6B_BEE_LOCKED = 0x6B, //[107] = "Locked", -- Bee, Mumbo Transform Cutscene
    BS_6C_WALRUS_OW = 0x6C,
    BS_6D_WALRUS_DIE = 0x6D,
    BS_6E_CROC_BITE = 0x6E,
    BS_6F_CROC_EAT_BAD = 0x6F,
    BS_70_CROC_EAT_GOOD = 0x70,
    BS_71_BTROT_FALL = 0x71,
    BS_72_SPLAT = 0x72, // Getting up after fall damage
    ...
    BS_9F_ANT_BOUNCE = 0x9F,
    BS_A0_ANT_BOUNCE = 0xA0,
    BS_A1_CROC_BOUNCE = 0xA1,
    BS_A2_WALRUS_BOUNCE = 0xA2,
    BS_A3_BEE_BOUNCE = 0xA3,
...
typedef enum asset_e
{
    ...
    ASSET_137_ANIM_GRIMLET_ATTACK = 0x137,
    ...
    ASSET_16A_ANIM_BELL_BUOY = 0x16A,
    ASSET_16B_ANIM_SNAREBEAR_ATTACK = 0x16B,
    ASSET_16C_ANIM_SNAREBEAR_IDLE = 0x16C,
    ...
    ASSET_173_ANIM_BEANSTALK_UNK = 0x173,
    ASSET_174_ANIM_BEANSTALK_UNK = 0x174,
    ASSET_175_ANIM_BEANSTALK_UNK = 0x175,
    ...
    ASSET_181_ANIM_BEANSTALK_UNK = 0x181,
    ASSET_182_ANIM_BEANSTALK_UNK = 0x182,
    ASSET_183_ANIM_BEANSTALK_UNK = 0x183,
    ...
    ASSET_18D_ANIM_CATERPILLAR_UNK = 0x18D,
    ASSET_18E_ANIM_CATERPILLAR_IDLE = 0x18E,

    ASSET_199_ANIM_EEYRIE_ADULT_UNK = 0x199,
    ASSET_19A_ANIM_EEYRIE_ADULT_UNK = 0x19A,
    ASSET_19B_ANIM_UNKNOWN = 0x19B,
    ASSET_19C_ANIM_BSWALRUS_BOUNCE = 0x19C,
    ...
    ASSET_1A3_ANIM_NABNUT_SPRING_LOOKING_AROUND = 0x1A3,
    ASSET_1A4_ANIM_NABNUT_SPRING_EATING = 0x1A4,

    ASSET_1A6_ANIM_GNAWTY_IDLE = 0x1A6,
    ASSET_1A7_ANIM_GNAWTY_CHEERING = 0x1A7,
    ASSET_1A8_ANIM_GNAWTY_RUNNING = 0x1A8,
    ...
    ASSET_21C_ANIM_SNORE_Z = 0x21C,
    ASSET_21D_ANIM_ADULT_EYRIE_UNK = 0x21D,
    ASSET_21E_ANIM_ADULT_EYRIE_UNK = 0x21E,
    ...
    ASSET_230_ANIM_PINK_SQUIRREL_UNK = 0x230,
    ASSET_231_ANIM_NABNUT_BEDSHEETS_UNK = 0x231,

    ASSET_233_ANIM_ICECUBE  = 0x233,
    ASSET_234_ANIM_DEAD_SNAREBEAR = 0x234,
    ...
    ASSET_2A1_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN = 0x2A1,
    ...
    ASSET_2C6_ANIM_MUMBOS_HAND_WITH_PICTURE = 0x2C6,
    ...
    ASSET_402_MODEL_EGG_TOLL = 0x402, // Floating Green Orb
    ...
    ASSET_41E_MODEL_RAREWARE_FLAG = 0x41E,
    ...
    ASSET_427_MODEL_WOODEN_PLANK = 0x427,
    ...
    ASSET_443_MODEL_ZUBBA_HONEY_LUMP = 0x443,
    ...
    ASSET_462_MODEL_PINK_SQUIRREL = 0x462,
    ASSET_463_MODEL_NABNUT_BEDSHEETS = 0x463,
    ASSET_464_MODEL_NABNUT_BED = 0x464,
    // 465 Dead Snarebear
    // 466 (Sparkle 2D?)
    ...
    ASSET_48D_MODEL_NABNUT_EATING_ACORNS = 0x48D,
    ...
    ASSET_501_MODEL_MOUND_OF_ACORNS = 0x501,
    ASSET_502_MODEL_NABNUT = 0x502,
    ASSET_503_MODEL_NABNUT_BELLY_FULL = 0x503,
    ASSET_504_MODEL_ICECUBE       = 0x504,
    ASSET_505_MODEL_ICECUBE_CHUNK = 0x505,
    ASSET_506_CCW_DEAD_SNAREBEAR = 0x506,
    ...
    ASSET_DA9_DIALOG_MUMBO_CCW_VACATION = 0xDA9,
    ...
    // [port] JP-exclusive sprites for world name banners
...
enum marker_e{
    ...
    MARKER_1B8_BOOM_BOX_MINIGAME_CTRL = 0x1B8,
    MARKER_1B9_NABNUT_SPRING = 0x1B9,
    ...
    MARKER_1C0_BOSS_BOOMBOX_CTRL = 0x1C0,
